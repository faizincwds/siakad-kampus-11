...
export default {
    ...
    darkMode: 'class', // Atau 'media' jika Anda lebih suka
    theme: {
        extend: {
        ...
        // Definisi keluarga font kustom
        fontFamily: {
            outfit: ['Outfit', 'sans-serif'],
        },
        // Definisi breakpoint kustom
        screens: {
            '2xsm': '375px',
            'xsm': '425px',
            '3xl': '2000px',
        },
        // Definisi bayangan kustom
        boxShadow: {
        ...
        // Definisi drop-shadow kustom
        dropShadow: {
            '4xl': '0 35px 35px rgba(0, 0, 0, 0.25), 0 45px 65px rgba(0, 0, 0, 0.15)',
        },
        // Definisi z-index kustom
        zIndex: {
            '1': '1',
            '9': '9',
            '99': '99',
