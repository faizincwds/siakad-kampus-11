<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Edit Semester: ' . $semester->nama_semester) }}
        </h2>
    </x-slot>
                    ...
                    <form action="{{ route('admin.semesters.update', $semester->id) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <x-text-input id="tahun_akademik" class="block mt-1 w-full" type="text" name="tahun_akademik" placeholder="Contoh: 2023/2024" :value="old('tahun_akademik', $semester->tahun_akademik)" required autofocus />
                            ...
                            <div>
                                ...
                                <x-forms.select-input id="jenis_semester" name="jenis_semester" class="block mt-1 w-full" required
                                    ...
                                    :value="old('jenis_semester', $semester->jenis_semester)"
                                />
                            ...
                            <div>
                                ...
                                <x-text-input id="nama_semester" class="block mt-1 w-full" type="text" name="nama_semester" placeholder="Contoh: Ganjil 2023/2024" :value="old('nama_semester', $semester->nama_semester)" required />
                                <x-input-error :messages="$errors->get('nama_semester')" class="mt-2" />
                            </div>

                            <div class="md:col-span-2">
                                <label for="is_active" class="inline-flex items-center">
                                    <input id="is_active" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="is_active" value="1" {{ old('is_active', $semester->is_active) ? 'checked' : '' }}>
