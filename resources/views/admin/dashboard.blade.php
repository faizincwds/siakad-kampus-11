...
@section('content')
    ...
    <div class="grid grid-cols-4 gap-4 md:gap-6">
	              ...
	              <div class="col-span-12 space-y-6 xl:col-span-12">
	                ...
	                <!-- Metric Group One -->
	                <div class="grid md:grid-cols-4 gap-6 sm:grid-cols-2 md:gap-6">

						  <!-- Metric Item Start -->
						  <div
						    class="rounded-2xl border border-gray-200 bg-white p-3 dark:border-gray-800 dark:bg-white/[0.03] md:p-4"
						  >
						    <div
						      class="flex items-center justify-items-normal"
						    >
						      <div
						      ...
						      >
						        ...
						        <span class="text-sm font-bold text-gray-800 dark:text-white/90">DOSEN</span>
						    </div>
						  ...
						  >
						    ...
						    >
						      ...
						      >
						        ...
						        <span class="text-sm font-bold text-gray-800 dark:text-white/90">MAHASISWA</span>
						    </div>
						  ...
						  >
						    ...
						    >
						      ...
						      >
						        ...
						        <span class="text-sm font-bold text-gray-800 dark:text-white/90">LULUSAN</span>
						    </div>
						  ...
						  >
						    ...
						    >
						      ...
						      >
						        ...
						        <span class="text-sm font-bold text-gray-800 dark:text-white/90">PROGRAM STUDI</span>
						    </div>
					...
					>
					  <div class="flex items-center justify-between">
					    <h3 class="w-full text-sm font-bold text-gray-800 dark:text-white/90">
					      STATISTIK MAHASISWA
					    </h3>
	              ...
	              <div class="col-span-12 xl:col-span-12">
	                ...
	                <div
						...
						>
						  ...
						  >
						    <div>
						      <h3 class="font-sm font-bold text-gray-800 dark:text-white/90">
						        Log Aktivitas
						      </h3>
						    </div>
						        ...
						        <tr class="border-gray-100 border-y dark:border-gray-800">
						          <th class="py-3">
						            <div class="flex items-center">
						              <p
						                class="font-medium text-gray-800 text-theme-xs dark:text-gray-400"
						              >
						                Activity
						              </p>
						            </div>
