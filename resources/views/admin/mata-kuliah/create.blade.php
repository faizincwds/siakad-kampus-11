        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="text-lg font-medium mb-4">Form Tambah Mata Kuliah</h3>
                    ...
                    <form action="{{ route('admin.mata-kuliah.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 @error('kode_mk') border-red-500 @enderror" id="kode_mk" name="kode_mk" value="{{ old('kode_mk') }}" required>
                            @error('kode_mk')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 @error('nama_mk') border-red-500 @enderror" id="nama_mk" name="nama_mk" value="{{ old('nama_mk') }}" required>
                            @error('nama_mk')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="mb-4">
                            ...
                            <input type="number" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 @error('sks') border-red-500 @enderror" id="sks" name="sks" value="{{ old('sks') }}" min="1" max="9" required>
                            @error('sks')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="mb-4">
                            ...
                            <input type="number" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 @error('semester') border-red-500 @enderror" id="semester" name="semester" value="{{ old('semester') }}" min="1" max="14" required>
                            @error('semester')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                            ...
                            <div class="mt-2 space-y-2">
                                @forelse ($kurikulums as $kurikulum)
                                    <div class="flex items-center">
                                        <input type="checkbox" name="kurikulum_ids[]" id="kurikulum_{{ $kurikulum->id }}" value="{{ $kurikulum->id }}" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" {{ in_array($kurikulum->id, old('kurikulum_ids', [])) ? 'checked' : '' }}>
