        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="text-lg font-medium mb-4">Form Tambah Fakultas</h3>

                    <form action="{{ route('admin.fakultas.store') }}" method="POST">
                        @csrf
                        <div class="mb-4">
                            <label for="nama" class="block text-sm font-medium text-gray-700">Nama Fakultas:</label>
                        ...
                        <div class="mb-4">
                            <label for="kode" class="block text-sm font-medium text-gray-700">Kode Fakultas (Opsional):</label>
